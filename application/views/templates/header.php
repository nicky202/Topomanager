...
<section id="container" class="">
	...
	<header class="header dark-bg">
		...
		<!--logo start-->
		<a href="<?php echo base_url();?>dashboard/dashboard/view_dashboard" class="logo">Topo<span class="lite">Manager</span></a>
		<!--logo end-->
			...
			<ul class="nav pull-right top-menu">
				...
				<li class="dropdown">
					<a data-toggle="dropdown" class="dropdown-toggle" href="#">
						...
						<span class="username"><?php if ($this->session->has_userdata('login')) { echo $this->session->userdata('login'); } ?></span>
						<b class="caret"></b>
					</a>
					<ul class="dropdown-menu extended logout">
						<div class="log-arrow-up"></div>
						<li class="eborder-top">
							<a href="<?php echo site_url('profile');?>"><i class="icon_profile"></i> My Profile</a>
						</li>
						<li>
						...
						<li>
							<a href="<?php echo base_url();?>authentification/utilisateur/deconnexion"><i class="icon_key_alt"></i> Deconnexion</a>
						</li>
						<li>
